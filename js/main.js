...
(function () {
  ...
  var BUTTON = 'button';
  var PX = 'px';
  var SERVER_REQUEST = 'https://javascript.pages.academy/keksobooking/data';
  ...
  var getData = function (dataServer) {
    for (var i = 0; i < PIN_COUNT; i++) {
  ...
  window.load(SERVER_REQUEST, onSuccess, onError);
})();
